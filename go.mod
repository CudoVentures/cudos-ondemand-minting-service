module github.com/CudoVentures/cudos-ondemand-minting-service
...
require (
	github.com/CudoVentures/cudos-node v1.0.1-0.20220921135101-657b3df5424a
...
require (
	...
	github.com/CosmWasm/wasmd v0.25.0 // indirect
